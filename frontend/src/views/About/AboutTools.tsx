    ...
    <div className="Tools">
      ...
      <div className="Toolcolumn">
        ...
        <figcaption className="caption">
          React: renders website and connects user-interface to backend{" "}
        </figcaption>
      </div>
      ...
      <div className="Toolcolumn">
        ...
        <figcaption className="caption">
          ReactBootstrap: CSS framework for website{" "}
        </figcaption>
      </div>
      <div className="Toolcolumn">
        ...
        <figcaption className="caption">
          AWS Elastic Beanstalk: hosts website from Git Repository{" "}
        </figcaption>
      </div>
      <div className="Toolcolumn">
      ...
      <div className="Toolcolumn">
        ...
        <figcaption className="caption">
          Jupyter Notebook: used to parse data
        </figcaption>
      </div>
    </div>
  );
