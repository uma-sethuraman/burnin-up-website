...
class tests(unittest.TestCase):
    ...
    def test_about(self):
        ...
        assert "https://datahelpdesk.worldbank.org/knowledgebase/articles/898599-indicator-api-queries" in self.driver.current_url
    ...
    def test_how_to_help(self):
        ...
        self.driver.find_elements_by_xpath("/html/body/div/div/div[2]/div/div[1]/div/a")[0].click()
        assert "https://www.rainforestcoalition.org/" in self.driver.current_url
        self.driver.get("https://burninup.me/howtohelp")
        self.driver.implicitly_wait(5)
        self.driver.find_elements_by_xpath("/html/body/div/div/div[2]/div/div[2]/div/a")[0].click()
